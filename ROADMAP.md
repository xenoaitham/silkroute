...
| 1 — Legacy ERP (SOAP, WSDL-first) | Untouchable legacy estate: WSDLs + XSDs first, Spring Boot + CXF, WS-Security, typed faults, seed data, Karate SOAP contract tests, WSDL freeze (C6) | **REVIEW** (S2) | E-004, E-005, E-006 | contracts authored + validated pre-Java; wsdl2java from frozen WSDLs; 15 unit + 16 contract tests green; freeze = ADR-0003 + tag `contract-freeze-erp-v1`; awaiting Phase 1 Critic Gate |
