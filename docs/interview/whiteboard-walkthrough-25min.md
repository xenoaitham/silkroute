...
Rehearse against a timer. SAY lines are first person, written to be spoken. Numbers are only from `evidence/EVIDENCE.md` (E-001…E-036) — if a number isn't in the ledger, don't say it. Say "validated IaC, sim runtime" every time cloud IaC appears; volunteer it, don't wait to be asked.
