...
Evidence/anchor: E-012 (cn-beijing planned values, no replication); E-013 (tag adjudication, SAE namespace exception); E-016 (static residency suite 7/7 + five-violation selftest, in CI); E-009 (masking proven); ADR-0005 consequences (no runtime CN evidence).
