...
Maple Retail Group is a fictional Canadian retailer; this doc maps the data plane
local simulation to the landing zone managed landing zone so either environment can
...
## Data plane (data plane) - OMS event store, Debezium CDC, lake (BUILT, sim-measured E-030..E-034)
