...
> **Honesty banner:** Maple Retail Group is a **fictional** company created as the scenario for a self-directed reference implementation. No real client, employer, or engagement is implied. Every artifact in this repo is bound by (integrity rules).
...
- The **review Gate**  scores architectural soundness by whether decisions trace to C1-C7. A design choice that traces to no constraint is suspect.
