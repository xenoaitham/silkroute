...
> "ICP filing applies only to servers located in the Chinese mainland"; "China requires ICP filing for non-commercial and ICP licensing for commercial Internet Information Services"; "You cannot serve Internet Information Services without a license or ICP filing." — https://www.alibabacloud.com/help/en/icp-filing/basic-icp-service/product-overview/what-is-an-icp-filing
> "Websites hosted on servers in the Chinese mainland require an ICP filing" and the site must "not [be] publicly accessible until your ICP filing is approved." — https://help.aliyun.com/en/icp-filing/basic-icp-service/product-overview/icp-filing-requirements-for-a-regular-website
...
4. **Communications-administration (MIIT provincial) review**: the provincial Communications Administration reviews and decides (the process overview's "Communications administration review" stage). The provider's process overview publishes a typical, non-binding window for each review stage and states the communications-administration review "cannot be expedited" — this runbook deliberately records no duration figure (open the cited process-overview URL for the published window); **plan the launch gate accordingly**: gate on the filing number being issued, never on a review date you do not control.
5. **Filing number issued → only then may the domain serve.** Until the number issues, the site must not be publicly accessible — per the requirements page quoted in the scope section, the filing must be approved before the website is publicly accessible. Sequence any launch checklist so "filing number issued" is a hard gate in front of "public endpoint live".
6. **Display obligations**: once issued, the filing number must be displayed on the site — Alibaba Cloud's guidance states that once the number is issued "you need to display it in the footer of your website" (https://www.alibabacloud.com/blog/597263 — note the quoted sentence addresses the ICP **license** number; the filing-number display requirement is provider-notice material), with the number shown at the bottom of the site and a link to the MIIT filing-query system (commonly `beian.miit.gov.cn` — confirm the exact link and placement at filing time, as this detail is provider-notice material rather than statute text).
