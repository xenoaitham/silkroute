...
- [ ] **Select the Art. 38 mechanism**: confirm non-CIIO status and volume below the CAC threshold (else security assessment per Art. 40); realistically, standard contract + provincial filing via the CAC 2023 Measures.
