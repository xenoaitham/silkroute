...
|---|---|---|
| `k6-orders.js` | integration-hub comfort proof at fixed rate (evidence E-010 - **do not modify**, proven artifact) | ramping-arrival-rate: 10 s ramp-up, then 60 s at `RPS` (default 20); `DURATION` env |
